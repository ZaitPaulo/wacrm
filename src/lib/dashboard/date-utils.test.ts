...
describe("mondayIndex", () => {
  // Las fechas llevan hora A PROPÓSITO. "2026-05-18" a secas es una
  // date-only string y ECMAScript la parsea como medianoche UTC, que en
  // cualquier huso al oeste de Greenwich cae el día anterior: en
  // America/Bogota (UTC-5) ese lunes se leía como domingo y el test
  // fallaba solo en las máquinas de aquí. `mondayIndex` trabaja en hora
  // local a propósito —lo dice la cabecera del módulo—, así que la
  // entrada tiene que construirse local, como en el resto del archivo.
  // El mediodía deja margen de sobra ante cualquier salto de horario.
