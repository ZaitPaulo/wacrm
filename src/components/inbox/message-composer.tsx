...
interface MessageComposerProps {
  ...
  /**
   * Si el canal de esta conversación admite plantillas aprobadas.
   *
   * Solo WhatsApp las tiene. Ofrecerlas en un hilo de Instagram sería
   * ofrecer algo que no existe de ese lado, y el envío fallaría después
