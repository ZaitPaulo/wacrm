...
import { IdentitySuggestions } from '@/components/contacts/identity-suggestions';
...
export default function ContactsPage() {
  ...
  const fetchContacts = useCallback(async () => {
    ...
    if (selectedTagIds.length > 0) {
      ...
      let query = supabase
        .from('contacts')
        .select('*', { count: 'exact' })
        // Las fichas absorbidas por una vinculación no se listan: todo
        // lo suyo vive ahora en la que quedó (migración 514). No se
        // borran, para poder deshacer.
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Fichas que podrían ser la misma persona. Se muestra arriba
          porque es una decisión que conviene tomar antes de trabajar la
          lista, y no aparece nada cuando no hay sugerencias. */}
      <IdentitySuggestions onLinked={fetchContacts} />
