...
async function findOrCreateConversation(
  ...
  // Acotado a WhatsApp: este camino solo envía por ahí. Sin el filtro,
  // un contacto con hilo de WhatsApp Y de Instagram haría que
  // `.maybeSingle()` fallara —error con ≥2 filas—, `existing` quedara
  // en null y se intentara insertar un duplicado que el índice único
  // rechaza. El envío moriría sin motivo aparente.
