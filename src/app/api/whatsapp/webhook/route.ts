...
async function processMessage(
  ...
  // The inserted row is read back because AI auto-reply needs to know
  // which message it is reacting to: its reply window is expressed as
  // "did anything happen after this row".
