# social-publishing-queue Specification

## Purpose
La cola de publicaciones a redes sociales: encolado por vehículo, revisión y aprobación humana antes de publicar, estados por red y reintentos.
## Requirements
