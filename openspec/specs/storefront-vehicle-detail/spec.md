# storefront-vehicle-detail Specification

## Purpose
La ficha de un vehículo en la vitrina pública: el precio y la acción de contacto nunca se pierden de vista, la galería permite recorrer y ubicarse, el código de referencia queda a la vista, y el visitante puede seguir buscando sin volver atrás.
## Requirements
