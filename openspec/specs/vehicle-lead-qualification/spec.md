# vehicle-lead-qualification Specification

## Purpose
El guion de calificación de un prospecto de compraventa: qué se le pregunta, cómo se etiqueta y cuándo pasa a un asesor.
## Requirements
