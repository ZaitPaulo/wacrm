# facebook-page-connection Specification

## Purpose
Cómo se conecta y se mantiene viva la página de Facebook del negocio: vinculación, token de página y desconexión sin afectar a las demás redes.
## Requirements
