# vehicle-photo-ordering Specification

## Purpose
Cómo se reordenan las fotos de un vehículo: arrastre desde toda la superficie de la foto, alternativa por teclado, y qué orden ve la vitrina y la publicación.
## Requirements
