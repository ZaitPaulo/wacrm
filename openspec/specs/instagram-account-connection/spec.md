# instagram-account-connection Specification

## Purpose
Cómo se conecta y se mantiene viva la cuenta de Instagram del negocio: vinculación, token y reconexión cuando caduca.
## Requirements
