# inbound-response-ownership Specification

## Purpose
Qué pasa con lo que responde el cliente dentro de un flujo: se captura, se entrega al asesor y no se pierde entre ejecuciones.
## Requirements
