# whatsapp-bsuid-identity Specification

## Purpose
Quien escribe por WhatsApp sin dar su teléfono se recibe, se reconoce y se le puede responder: la identidad de negocio (BSUID) que informa Meta vale como identidad de canal, y no parte en dos la ficha de nadie.
## Requirements
